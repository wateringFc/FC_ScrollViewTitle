...
extension UICollectionView {
    /// 注册 cell 的方法
    func fc_registerCell<T: UICollectionViewCell>(cell: T.Type) where T: RegisterCellFromNib {
    ...
    /// 从缓存池池出队已经存在的 cell
    func fc_dequeueReusableCell<T: UICollectionViewCell>(indexPath: IndexPath) -> T where T: RegisterCellFromNib {
        return dequeueReusableCell(withReuseIdentifier: T.identifier, for: indexPath) as! T
    }
    
    /// 注册头部
    func fc_registerSupplementaryHeaderView<T: UICollectionReusableView>(reusableView: T.Type) where T: RegisterCellFromNib {
    ...
    /// 获取可重用的头部
    func fc_dequeueReusableSupplementaryHeaderView<T: UICollectionReusableView>(indexPath: IndexPath) -> T where T: RegisterCellFromNib {
